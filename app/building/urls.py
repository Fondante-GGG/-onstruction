...
from .auth_views import RemoteLoginView, RemoteLogoutView
from .views import (
...
urlpatterns = [
    ...
    # Auth Proxy to NurCRM
    path("auth/login/", RemoteLoginView.as_view(), name="remote-login"),
    path("auth/logout/", RemoteLogoutView.as_view(), name="remote-logout"),
]
